...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Me", "TestHaxeProject", "TestHaxeProject", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TestHaxeProject", null, { width: 500, height: 500 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 500, height: 500 });
			#end
